        ...
        <b-form @submit.prevent="passes(onSubmit)" @reset.prevent="onReset">
          ...
          <b-form-group>
            ...
            <b-button
              ...
              class="button-hero"
            >
              <font-awesome-icon :icon="['fas', 'trash-restore']" />  {{ $t('terug zetten') }}
            </b-button>
            <b-button
              type="button"
              variant="danger"
              ...
              @click="onDeleteInfo"
            >
              <font-awesome-icon :icon="['fas', 'user-minus']" />  {{ $t('ProjectWissen') }}
            </b-button>
...
export default {
  ...
  computed: {
    ...
    project_type: {
      set (value) {
        this.$store.dispatch('project/project_type', value)
      },
      get () {
    ...
    project_code: {
      set (value) {
        this.$store.dispatch('project/project_code', value)
      },
      get () {
    ...
    project_lang: {
      set (value) {
        this.$store.dispatch('project/project_lang', value)
      },
      get () {

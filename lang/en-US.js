export default {
    ...
    'intro2': 'On Sunday April 25th 2021 our interactive ONLINE edition will go live, with all your cool projects.',
    'jongen': 'Boy',
    ...
    'rule4': 'You can collaborate with maximum 4 participants on one project. All participants need to register. First the project owner registers the project. After confirmation, all the other participants can join this project after receiving an invitation mail from the project owner with a registration token. ',
    'rule6': 'For a valid entry, you need to send in a video. The duration needs to be between 1 and 3 minutes. The video has to reach us before April 9th 23:59.',
    'rule5': 'After registrations the participants can change the user information on the project. Only the project owner can change his project information. All changes need to be final on April 9th. ',

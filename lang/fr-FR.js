export default {
  ...
  body: "Bonjour <ami>,%0D%0A%0D%0ASi tu souhaites participer à mon projet, inscris-toi en utilisant le lien suivant vers la page d'inscription du projet Coolest Projects 2022:%0D%0A%0D%0A",
  Cancel: 'Annuler',
  ...
  intro: 'Lors du Coolest Projects Belgium, les jeunes créateurs présentent leur créativité numérique.',
  intro2: 'Veux-tu te joindre à nous le {officialStartDate}?',
  jongen: 'Garçon',
  ...
  rule2: 'Chaque participant.e est âgé de {minAge} à {maxAge} ans et réside en Belgique.',
  ...
  rule8: "Nous attendons de vous d'être disponible le {officialStartDate} afin de présenter votre projet.",
  ...
  rule10: 'Nous respectons toutes les données personnelles. La déclaration de confidentialité disponible sur le site web de CoderDojo {privacy_link}',
  privacy_text: 'declaration de confidentialité',
  ...
  'description_Je moet akkoord': "Tu dois accepter la question ci-dessus pour t'inscrire",
